...
namespace directhook::d3d12
{
	...
	using PFN_D3D12Device_GetResourceAllocationInfo = D3D12_RESOURCE_ALLOCATION_INFO(STDMETHODCALLTYPE*)(ID3D12Device*, UINT, UINT, const D3D12_RESOURCE_DESC*);
	...
	using PFN_D3D12Device_CreateSharedHandle = HRESULT(STDMETHODCALLTYPE*)(ID3D12Device*, ID3D12DeviceChild*, const SECURITY_ATTRIBUTES*, DWORD, LPCWSTR, HANDLE*);
	using PFN_D3D12Device_OpenSharedHandle = HRESULT(STDMETHODCALLTYPE*)(ID3D12Device*, HANDLE, REFIID, void**);
	using PFN_D3D12Device_OpenSharedHandleByName = HRESULT(STDMETHODCALLTYPE*)(ID3D12Device*, LPCWSTR, DWORD, HANDLE*);
	using PFN_D3D12Device_MakeResident = HRESULT(STDMETHODCALLTYPE*)(ID3D12Device*, UINT, ID3D12Pageable* const*);
	using PFN_D3D12Device_Evict = HRESULT(STDMETHODCALLTYPE*)(ID3D12Device*, UINT, ID3D12Pageable* const*);
	...
	using PFN_D3D12Device_GetCopyableFootprints = void(STDMETHODCALLTYPE*)(ID3D12Device*, const D3D12_RESOURCE_DESC*, UINT, UINT, UINT64, D3D12_PLACED_SUBRESOURCE_FOOTPRINT*, UINT*, UINT64*, UINT64*);
	...
	using PFN_D3D12Device_GetResourceTiling = void(STDMETHODCALLTYPE*)(ID3D12Device*, ID3D12Resource*, UINT*, D3D12_PACKED_MIP_DESC*, D3D12_TILE_SHAPE*, UINT*, UINT, D3D12_SUBRESOURCE_TILING*);
	...
	using PFN_D3D12Device1_SetEventOnMultipleFenceCompletion = HRESULT(STDMETHODCALLTYPE*)(ID3D12Device1*, ID3D12Fence* const*, const UINT64*, UINT, D3D12_MULTIPLE_FENCE_WAIT_FLAGS, HANDLE);
	using PFN_D3D12Device1_SetResidencyPriority = HRESULT(STDMETHODCALLTYPE*)(ID3D12Device1*, UINT, ID3D12Pageable* const*, const D3D12_RESIDENCY_PRIORITY*);
	...
	using PFN_D3D12Device3_EnqueueMakeResident = HRESULT(STDMETHODCALLTYPE*)(ID3D12Device3*, D3D12_RESIDENCY_FLAGS, UINT, ID3D12Pageable* const*, ID3D12Fence*, UINT64);
	...
	using PFN_D3D12Device4_GetResourceAllocationInfo1 = D3D12_RESOURCE_ALLOCATION_INFO(STDMETHODCALLTYPE*)(ID3D12Device4*, UINT, UINT, const D3D12_RESOURCE_DESC*, D3D12_RESOURCE_ALLOCATION_INFO1*);
	...
	using PFN_D3D12CommandQueue_UpdateTileMappings = void(STDMETHODCALLTYPE*)(ID3D12CommandQueue*, ID3D12Resource*, UINT, const D3D12_TILED_RESOURCE_COORDINATE*, const D3D12_TILE_REGION_SIZE*, ID3D12Heap*, UINT, const D3D12_TILE_RANGE_FLAGS*, const UINT*, const UINT*, D3D12_TILE_MAPPING_FLAGS);
	...
	using PFN_D3D12CommandList_ResolveQueryData = void(STDMETHODCALLTYPE*)(ID3D12GraphicsCommandList*, ID3D12QueryHeap*, D3D12_QUERY_TYPE, UINT, UINT, ID3D12Resource*, UINT64);
