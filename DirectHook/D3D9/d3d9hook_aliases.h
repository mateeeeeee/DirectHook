...
namespace directhook::d3d9
{
	...
	using PFN_D3D9Device_GetAvailableTextureMem = UINT(STDMETHODCALLTYPE*)(IDirect3DDevice9*);
	...
	using PFN_D3D9Device_SetCursorProperties = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, UINT, IDirect3DSurface9*);
	using PFN_D3D9Device_SetCursorPosition = void(STDMETHODCALLTYPE*)(IDirect3DDevice9*, int, int, DWORD);
	...
	using PFN_D3D9Device_GetRasterStatus = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, D3DRASTER_STATUS*);
	using PFN_D3D9Device_SetDialogBoxMode = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, BOOL);
	using PFN_D3D9Device_SetGammaRamp = void(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, DWORD, const D3DGAMMARAMP*);
	using PFN_D3D9Device_GetGammaRamp = void(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, D3DGAMMARAMP*);
	...
	using PFN_D3D9Device_CreateRenderTarget = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, UINT, D3DFORMAT, D3DMULTISAMPLE_TYPE, DWORD, BOOL, IDirect3DSurface9**, HANDLE*);
	using PFN_D3D9Device_CreateDepthStencilSurface = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, UINT, D3DFORMAT, D3DMULTISAMPLE_TYPE, DWORD, BOOL, IDirect3DSurface9**, HANDLE*);
	using PFN_D3D9Device_UpdateSurface = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, IDirect3DSurface9*, const RECT*, IDirect3DSurface9*, const POINT*);
	using PFN_D3D9Device_UpdateTexture = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, IDirect3DBaseTexture9*, IDirect3DBaseTexture9*);
	...
	using PFN_D3D9Device_Clear = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, DWORD, const D3DRECT*, DWORD, D3DCOLOR, float, DWORD);
	...
	using PFN_D3D9Device_GetTexture = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, DWORD, IDirect3DBaseTexture9**);
	using PFN_D3D9Device_SetTexture = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, DWORD, IDirect3DBaseTexture9*);
	...
	using PFN_D3D9Device_SetSoftwareVertexProcessing = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, BOOL);
	using PFN_D3D9Device_GetSoftwareVertexProcessing = BOOL(STDMETHODCALLTYPE*)(IDirect3DDevice9*);
	using PFN_D3D9Device_SetNPatchMode = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, float);
	...
	using PFN_D3D9Device_DrawIndexedPrimitive = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, D3DPRIMITIVETYPE, INT, UINT, UINT, UINT, UINT);
	using PFN_D3D9Device_DrawPrimitiveUP = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, D3DPRIMITIVETYPE, UINT, const void*, UINT);
	using PFN_D3D9Device_DrawIndexedPrimitiveUP = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, D3DPRIMITIVETYPE, UINT, UINT, UINT, const void*, D3DFORMAT, const void*, UINT);
	using PFN_D3D9Device_ProcessVertices = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, UINT, UINT, IDirect3DVertexBuffer9*, IDirect3DVertexDeclaration9*, DWORD);
	...
	using PFN_D3D9Device_GetVertexShaderConstantF = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, float*, UINT);
	using PFN_D3D9Device_SetVertexShaderConstantI = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, const int*, UINT);
	using PFN_D3D9Device_GetVertexShaderConstantI = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, int*, UINT);
	using PFN_D3D9Device_SetVertexShaderConstantB = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, const BOOL*, UINT);
	using PFN_D3D9Device_GetVertexShaderConstantB = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, BOOL*, UINT);
	...
	using PFN_D3D9Device_GetPixelShaderConstantF = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, float*, UINT);
	using PFN_D3D9Device_SetPixelShaderConstantI = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, const int*, UINT);
	using PFN_D3D9Device_GetPixelShaderConstantI = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, int*, UINT);
	using PFN_D3D9Device_SetPixelShaderConstantB = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, const BOOL*, UINT);
	using PFN_D3D9Device_GetPixelShaderConstantB = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, BOOL*, UINT);
	using PFN_D3D9Device_DrawRectPatch = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, const float*, const D3DRECTPATCH_INFO*);
	using PFN_D3D9Device_DrawTriPatch = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT, const float*, const D3DTRIPATCH_INFO*);
	using PFN_D3D9Device_DeletePatch = HRESULT(STDMETHODCALLTYPE*)(IDirect3DDevice9*, UINT);
